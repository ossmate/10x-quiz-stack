...
This project uses the "new-york" style variant with base color "neutral" and CSS variables to create themes, according to the configuration in the `components.json` section.
